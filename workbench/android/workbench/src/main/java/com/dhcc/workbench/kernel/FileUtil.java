...
public class FileUtil {
    ...
    public static double getFileSize(String filePath, int sizeType) {
        ...
        return FormatterFileSize(blockSize, sizeType);
    }
    ...
    public static String getAutoFileSize(File file) {
        ...
        return FormatterFileSize(blockSize);
    }
     ...
     * @return
     */
    private static String FormatterFileSize(long fileS) {
     ...
     * @return
     */
    private static double FormatterFileSize(long fileS, int sizeType) {
        DecimalFormat df = new DecimalFormat("#.00");
